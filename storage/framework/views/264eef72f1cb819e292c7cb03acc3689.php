...
<div class="container">
    ...
    <a href="<?php echo e(route('typfilmu.create')); ?>" class="btn btn-primary mb-3">Dodaj nowy Typ Filmu <br></a>
    ...
    <form action="<?php echo e(route('typfilmu.index')); ?>" method="GET" class="d-inline ms-3">
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\20461\projekt\resources\views/typfilmu/index.blade.php ENDPATH**/ ?>