<div class="container my-5">
    <form method="POST" action="<?php echo e(route('aktor.store')); ?>">
        <?php echo csrf_field(); ?>
        <div class="row">
            <!-- Tytul -->
            <div class="col-md-6 mb-3">
                <label for="imie" class="form-label">Imie</label>
                <input type="text" class="form-control" id="imie" name="imie" value="<?php echo e(old('imie', $aktor->imie ?? '')); ?>" required>
            </div>

            <!-- Data premiery -->
            <div class="col-md-6 mb-3">
                <label for="nazwisko" class="form-label">Nazwisko</label>
                <input type="text" class="form-control" id="nazwisko" name="nazwisko" value="<?php echo e(old('nazwisko', $aktor->nazwisko ?? '')); ?>">
            </div>
        </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <select multiple id="filmy" name="filmy[]" class="form-control">
                    <?php $__currentLoopData = $filmy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $film): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($film->id); ?>" <?php echo e(in_array($film->id, old('filmy', $aktor->filmy->pluck('id')->toArray() ?? [])) ? 'selected' : ''); ?>>
...
<?php /**PATH C:\xampp\htdocs\20461\projekt\resources\views/aktor/partials/form.blade.php ENDPATH**/ ?>