...
<div class="container">
    ...
    <a href="<?php echo e(route('aktor.create')); ?>" class="btn btn-primary mb-3">Dodaj nowego aktora <br></a>
    ...
    <form action="<?php echo e(route('aktor.index')); ?>" method="GET" class="d-inline ms-3">
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\20461\projekt\resources\views/aktor/index.blade.php ENDPATH**/ ?>