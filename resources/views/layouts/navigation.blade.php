        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('aktor.index')" :active="request()->routeIs('aktor.index')">
                        {{ __('Aktorzy') }}
                    </x-nav-link>
                    <x-nav-link :href="route('autor.index')" :active="request()->routeIs('autor.index')">
                        {{ __('Autorzy') }}
                    </x-nav-link>
                    <x-nav-link :href="route('typfilmu.index')" :active="request()->routeIs('typfilmu.index')">
                        {{ __('Typy Filmów') }}
                    </x-nav-link>
                    @admin
                    <x-nav-link :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')" class="text-red-500">
                        {{ __('Admin') }}
                    </x-nav-link>
                    @endadmin
                </div>
